ActiveAdmin.register Invoice, as: 'RegistrationPayment' do
  ...
  controller do
    ...
    def testmoodle
      if @registration_payment.payment_transaction.finance_approval_status == 'approved'
        @moodle = MoodleRb.new('5416adef8a15c2a82837c08f0704ee90', 'https://lms.cpucollege.edu.et/webservice/rest/server.php')
  ...
  index do
    ...
    column 'Program', sortable: true do |n|
      n.program.program_name if n.program.present?
    end
  ...
  action_item :edit, only: :show, priority: 1 do
    if ((current_admin_user.role == 'admin') || (current_admin_user.role == 'finance head')) && !registration_payment.payment_transaction.present?
      link_to 'Add Payment Information',
              edit_admin_registration_payment_path(registration_payment.id, page_name: 'payment_transaction')
  ...
  action_item :delete, only: :show, priority: 1 do
    if (current_admin_user.role == 'admin') || (current_admin_user.role == 'finance head')
      link_to 'Delete Invoice', admin_registration_payment_path(registration_payment), method: :delete,
      ...
      column do
        panel 'invoice summery' do
          attributes_table_for registration_payment do
            ...
            if registration_payment.registration_fee > 0
              number_row :registration_fee, as: :currency, unit: 'ETB', format: '%n %u', delimiter: ',',
                                            precision: 2
            end
            if registration_payment.late_registration_fee > 0
