class StudentTemporary < Prawn::Document
  def initialize(students, degree, _gc_date)
    ...
    @students.each_with_index do |stud, _index|
      ...
      move_down 10
      text 'CPU COLLEGE', inline_format: true, size: 20, align: :center
      move_down 10
      ...
      move_down 20
      text 'Graduated from CPU College', inline_format: true, size: 18, align: :center
      move_down 20
      ...
      move_down 20
      text "<u>On #{Date.parse('2023-08-01').strftime('%d %B,%Y')}</u>", inline_format: true, size: 22,
                                                                         font_style: :bold, align: :center
      move_down 20
